...
function Login({ handleStepChange, currentStep }: FormDefaultPropsType) {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.button_wrapper}>
          ...
          >
            {isLoading ? (
              ...
              <span onClick={() => handleStepChange(currentStep + 1)}> Sign In</span>
            )}
          </Button>
        </div>
        ...
        <span className={styles.googleIcon}onClick={googleAuth}>Sign in with Google</span>
      </Button>
